...
namespace Core
{
    namespace DDS
    {
        ...
        CORE_API Core::Expected<ParseResult, Exception> Parse(std::span<const std::uint8_t> data);
        ...
        CORE_API Core::Expected<ImageResult, Exception> Resolve(const ParseResult& result);
    }
};