...
namespace Core
{
    ...
    constexpr static DeviceSize PoolNodeDataOffsetsMask = NumericLimits<DeviceSize>::Max - 1; //011111...11111
...
#pragma message("TODO")
    ...
    {
        //blk curr blk -> no merge

#pragma message("TODO")
        //find prev and next free blocks
        //check merge required
        //update pointers in neighbours
