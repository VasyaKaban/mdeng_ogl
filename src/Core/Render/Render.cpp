...
namespace Render
{
    ...
    FormatComponentsBitSize GetFormatComponentsBitSize(Format format) noexcept
    {
        ...
        {
            case Format::R64_FLOAT:
                components = FormatComponentsBitSize{.red = 64, .green = 0, .blue = 0, .alpha = 0};
                break;
            case Format::R64G64_FLOAT:
                components = FormatComponentsBitSize{.red = 64, .green = 64, .blue = 0, .alpha = 0};
                break;
            case Format::R64G64B64_FLOAT:
                components =
                    FormatComponentsBitSize{.red = 64, .green = 64, .blue = 64, .alpha = 0};
                break;
            case Format::R64G64B64A64_FLOAT:
                components =
                    FormatComponentsBitSize{.red = 64, .green = 64, .blue = 64, .alpha = 64};
                break;
            case Format::R32G32B32A32_FLOAT:
            case Format::R32G32B32A32_UINT:
            case Format::R32G32B32A32_SINT:
